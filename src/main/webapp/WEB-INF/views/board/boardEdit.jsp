...
<div class="row">
	...
	<!--파일 업로드시 method: POST enctype: multipart/form-data -->
		...
		<!-- ---------------------------------------------------- -->
			...
			<table class="table">
				...
				<tr>
					...
					<td style="width: 80%">
						<input type="text" name="userid" id="userid" 
							value="${board.userid}" class="form-control">
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="width: 80%">
						<!-- <div class="col-md-5"> -->
							<input type="password" name="passwd" id="bpwd"
								class="form-control">
						<!-- </div> -->
					</td>
				</tr>
				<tr>
					...
					<td style="width: 80%">
						...
						<c:if test="${board.filename ne null}">
							...
							<img class="img img-thumbnail" src="../resources/board_upload/
								<c:out value="${board.filename}" />" style="width:80px">
							</c:if>
				...
				<tr>
					<td colspan="2" class="text-center">
						<button type="submit" id="btnWrite" class="btn btn-success">수정하기</button>
